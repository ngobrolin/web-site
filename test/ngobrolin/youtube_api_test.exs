defmodule Ngobrolin.YoutubeMockApi do
  def request_episodes_from_playlist(_playlist_id) do
    Jason.encode!(%{
      ...
      nextPageToken:
        "EAAajQFQVDpDRElpRUVJd1JEWXlPVGsxTnpjME5rVkZRMEVvQVVqanZhN1Zocm1HQTFBQldrUWlRMmxLVVZSR1VscE5iVFZZVGtkd00yUkZZelJWTTJkNVVXNWpNbFZXVG05UmVra3pUVlpDTmxkRVRYaFJNMUpWUldkelNUUnllbkJ6WjFsUmRVdFlaRVozSWc",
      items: [
        %{
...
defmodule Ngobrolin.YoutubeApiTest do
  ...
  test "Get episodes from playlist" do
    episodes =
      Ngobrolin.YoutubeMockApi.request_episodes_from_playlist(@playlist_id)
